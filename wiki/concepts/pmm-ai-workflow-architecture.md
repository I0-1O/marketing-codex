...
related: [ai-agent-skills-for-marketing, buyer-voice-intelligence, voice-as-text-file, pmm-scope-creep]
---
...
- [[pmm-scope-creep]] — the organizational problem AI architecture partially addresses; AI reclaims production capacity but doesn't solve a charter problem
